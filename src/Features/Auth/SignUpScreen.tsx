...
export default function SignUpScreen() {
    ...
    const heroHeight = verticalScale(250)
            ...
            <SafeAreaView edges={["top","bottom"]} className="flex-1 z-20">
                ...
                >
                    ...
                    >
                        ...
                        >
                            {`Join Brothers Food Delivery and enjoy\ndelicious meals in minutes`}
                        </Text>

                        <Text
                            className="font-medium text-[#1F1F1F]/85 self-start"
                            style={{ fontSize: moderateScale(13), marginTop: verticalScale(20), marginLeft: scale(6) }}
                        >
                            Full Name
                        </Text>
                        ...
                        <View className={`w-full flex-row overflow-hidden
                            ...
                            style={{ marginTop: verticalScale(6), height: verticalScale(46), borderRadius: moderateScale(10) }}
                        >
                        ...
                        <View
                            className={`w-full flex-row items-center overflow-hidden
                            ${passwordError ? "border border-red-400" : "border border-[#1F1F1F]/10"} bg-white`}
                            style={{
                                marginTop: verticalScale(6),
                                paddingRight: scale(10),
                                paddingLeft: scale(9),
                        ...
                        >
                            ...
                            >
                                <LockIcon width={scale(20)} height={scale(20)} color={"#655145"} /> 
                            </View>
                            ...
                            >
                                {showPassword ? (
                                    <EyeOpenIcon width={scale(24)} height={scale(24)} color={"#655145"} />
                                ) : (
                                    <EyeClosedIcon width={scale(24)} height={scale(24)} color={"#655145"} />
                                )}
                            </TouchableOpacity>
                        </View>
                        ...
                        <View
                            className={`w-full flex-row items-center overflow-hidden
                            ${confirmPasswordError ? "border border-red-400" : "border border-[#1F1F1F]/10"} bg-white`}
                            style={{
                                marginTop: verticalScale(6),
                                paddingRight: scale(10),
                                paddingLeft: scale(9),
